...
module.exports = {
  ...
  english: {
    language: 'en-US',
    voice: 'WOMAN',
    welcome_prompt: 'Welcome to the Plivo I V R Demo. Press 1 for English. Press 2 for Spanish.',
    welcome_prompt_retry: 'Please press 1 for English. Press 2 for Spanish.',
    redirect_msg: 'English selected.',
    menu_prompt: 'English menu. Press 1 to hear a message. Press 2 to talk to an associate. Press 0 to return to the main menu.',
  ...
  spanish: {
    ...
    menu_prompt: 'Menú en español. Presione 1 para escuchar un mensaje. Presione 2 para hablar con un agente. Presione 0 para volver al menú principal.',
